 ...
 * @author judag
 */
public class frmListarFormaFarmaceutica extends javax.swing.JFrame {

    /**
     * Creates new form frmListarFormaFarmaceutica
     */
    public frmListarFormaFarmaceutica() {
        initComponents();
        this.jgdForma.getTableHeader().setFont(new Font("Century Gothic", Font.PLAIN, 14));
        JTableHeader cabecera = this.jgdForma.getTableHeader();
    ...
    private void initComponents() {
        ...
        setTitle("ListarFormaFarmaceutica");
        setResizable(false);
