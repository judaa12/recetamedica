 ...
 * @author judag
 */
public class frmListarViaAdministracion extends javax.swing.JFrame {

    /**
     * Creates new form frmListarViaAdministracion
     */
    public frmListarViaAdministracion() {
        initComponents();
        this.jgdVia.getTableHeader().setFont(new Font("Century Gothic", Font.PLAIN, 14));
        JTableHeader cabecera = this.jgdVia.getTableHeader();
    ...
    private void initComponents() {
        ...
        setTitle("ListarViaAdministracion");
        setResizable(false);
