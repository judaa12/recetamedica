 ...
 * @author judag
 */
public class frmModificarIndicacionGeneral extends javax.swing.JFrame {

    /**
     * Creates new form frmModificarIndicacionGeneral
     */
    public frmModificarIndicacionGeneral() {
        initComponents();
        this.setLocationRelativeTo(null);
        TextPrompt placeHolderConcepto = new TextPrompt("Concepto", txtConcepto);         
    }
    ...
    private void initComponents() {
        ...
        setTitle("ModificarIndicacionGeneral");
        setResizable(false);
        ...
        txtConcepto.setFont(new java.awt.Font("Century Gothic", 0, 14)); // NOI18N
        txtConcepto.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        jPanel2.add(txtConcepto);
